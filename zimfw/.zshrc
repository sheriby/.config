...
export PATH="$PATH:/home/sher/miniconda3/bin:/home/sher/.local/bin:/home/sher/go/bin:/home/sher/Scripts"
...
#plugins=(git z extract zsh-autosuggestions fast-syntax-highlighting zsh-completions)
...
#alias killjk="kill -KILL $(ps aux | grep jupyter | awk '{print $2}' | head -1)"
